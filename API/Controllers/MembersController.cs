...
namespace API.Controllers
{
    ...
    public class MembersController(IUnitOfWork unitOfWork, IPhotoService photoService) : BaseApiController
    {
        ...
        [HttpGet("{id}/photos")]
        public async Task<ActionResult<IReadOnlyList<Photo>>> getPhotosById(string id)
        {
        ...
        public async Task<ActionResult> UpdateMember(MemberUpdateDto memberUpdateDto)
        {
            ...
            unitOfWork.MemberRepository.Update(member); // Don't need to

            if (await unitOfWork.Complete()) return NoContent();
            return BadRequest("Failedto update user");
        }
        ...
        public async Task<ActionResult> SetMainPhoto(int photoId)
        {
            ...
            if (member.ImageUrl == photo?.ImageUrl || photo == null)
            {
                return BadRequest("Cannot set this to main image");
            }
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            if (photo == null || photo.ImageUrl == member.ImageUrl)
            {
